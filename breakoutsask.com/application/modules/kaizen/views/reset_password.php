...
<div id="container">
	...
	<div id="body">
            ...
            <form  method="post" action="<?php echo base_url("kaizen/forgot_pwd/temp_reset_password/"); ?>" id="login_frm"  />
             <input type="hidden" name="hdn_temp_pwd" value="<?php echo $temp_pass; ?>">
				<div class="control-group">
					<label for="email"> Password</label>
					<input class="box" type="text" id="password" name="password" />
				</div>
