...
//});
    ...
    style=" <?php if(count($calltoaction_background) != 0 && $calltoaction_background[0]->block_background_image != ''){ ?> background-image:url('<?php echo $calltoactionback; ?>'); background-repeat: no-repeat; <?php } ?>">
    	<div class="wrapper">
            ...
            <?php if(!empty($calltoaction_featuredblocks_arr)){ ?>
            <ul>
             <?php foreach($calltoaction_featuredblocks_arr as $row_calltoaction_featuredblocks){ 
			$calltoaction_icon = file_upload_base_url()."featured_block_image/"."homethumb_".$row_calltoaction_featuredblocks->featured_block_image;
            ...
            <div class="contact-info-section">
                ...
                <div class="home-contact-form">
                    ...
                    <?php 
                        ...
                        <textarea id="comment" name="comment" placeholder="Comments" class="validate[required]"></textarea>
