...
class Model_home extends CI_Model{
	...
	public function getFeaturedblocks($section_type){
		if($query = $this->db->query("SELECT * FROM `".$this->db->dbprefix('featured_blocks')."` WHERE block_section_type = '".$section_type."' and is_featured = '1' and featured_block_status = 'Active' "))
		{
			#echo $this->db->last_query();
